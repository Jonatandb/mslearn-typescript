# Microsoft Learn: [Compilación de aplicaciones JavaScript con TypeScript](https://docs.microsoft.com/es-es/learn/paths/build-javascript-applications-typescript/)
